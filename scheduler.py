...
def evolutionary_algorithm(
    matrix, data, free, filled, groups_empty_space, teachers_empty_space, subjects_order
):
    """
    ...
    for run in range(run_times):
        ...
        while stagnation < max_stagnation:
            ...
            loss_before, cost_classes, cost_teachers, cost_classrooms, cost_groups = (
...
def start(data: str):
    ...
    data = load_data(data, teachers_empty_space, groups_empty_space, subjects_order)
